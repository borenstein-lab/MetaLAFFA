"""
Ortholog map summary combine step parameters
---------------------------

This configuration submodule contains parameters related to the ortholog map summary combine pipeline step.
"""
...
input_dic = {
    "input": {"prior_step": 0, "file": "{sample}.summary.txt"}
}
"""
Dictionary defining the pipeline step's input structure.
"""

step_prefix = "ortholog_map_summary_combine"
"""
