"""
Ortholog aggregation summary combine step parameters
---------------------------

This configuration submodule contains parameters related to the ortholog aggregation summary combine pipeline step.
"""
...
input_dic = {
    "input": {"prior_step": 0, "file": "{mapping}.summary.txt"}
}
"""
Dictionary defining the pipeline step's input structure.
"""

step_prefix = "ortholog_aggregation_summary_combine"
"""
