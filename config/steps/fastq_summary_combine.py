"""
FASTQ summary combine step parameters
---------------------------

This configuration submodule contains parameters related to the fastq summary combine pipeline step.
"""
...
step_prefix = "fastq_summary_combine"
"""
