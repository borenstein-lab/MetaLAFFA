...
parser = argparse.ArgumentParser(description="Generates summary statistics about a duplicate-filtered FASTQ file")
...
summary_stat_names = ["post_duplicate_filter_reads", "post_duplicate_filter_average_read_length", "post_duplicate_filter_average_base_quality"]
