...
parser.add_argument("blast_output", help="blast output file for which to summarize mapping")
...
# Otherwise, we associate this summary with the blast output file name
else:
    column_names.append("blast_output")

# Add the column names for the summary stats to the list of column names
summary_stat_names = ["matched_reads", "matches", "average_e_value"]
