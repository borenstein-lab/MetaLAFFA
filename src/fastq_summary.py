...
parser = argparse.ArgumentParser(description="Generates summary statistics about a FASTQ file")
...
summary_stat_names = ["reads", "average_read_length", "average_base_quality"]
