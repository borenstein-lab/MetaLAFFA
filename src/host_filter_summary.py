...
parser = argparse.ArgumentParser(description="Generates summary statistics about a host-filtered FASTQ file")
...
summary_stat_names = ["post_host_filter_reads", "post_host_filter_average_read_length", "post_host_filter_average_base_quality"]
