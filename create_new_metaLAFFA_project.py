...
subprocess.run(["cp", "-r", "config", args.new_directory + "/config"])
...
modify_config_module(args.new_directory + "/config/file_organization.py", all_paths_to_modify)
modify_config_module(args.new_directory + "/config/operation.py", all_paths_to_modify)
